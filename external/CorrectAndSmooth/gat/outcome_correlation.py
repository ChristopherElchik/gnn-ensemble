...
def evaluate_params(data, eval_test, model_outs, split_idx, params, fn=double_correlation_autoscale, save_dir=None):
    ...
    for out in model_outs:
        ...
        # Save final C&S predictions
        if save_dir is not None:
            torch.save(result, f'{save_dir}/run{run}.pt')
            print(f"Saved final predictions to {save_dir}/run{run}.pt")
